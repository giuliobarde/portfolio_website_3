...
export default function Button({ 
    ...
    return (
        <PrismicNextLink 
            field={linkField}
            className={clsx(
                "group relative flex w-fit text-slate-800 items-center justify-center overflow-hidden rounded-md border-2 border-slate-900 bg-slate-50 px-4 py-2 font-bold transition-all ease-out hover:scale-105 hover:border-yellow-400 hover:shadow-[0_0_15px_rgba(251,191,36,0.3)]",
                className)}
        >
